...
Page({
  ...
  getOrderInfo(){
    ...
    var requesturl = config.RequestAddressPrefix6 + '/order/v1/undone';
    var that = this;
    wx.request({
      url: requesturl,
      method: "POST",
  ...
  contactCustomerService(event){
    ...
    var requesturl = config.RequestAddressPrefix6 + '/survey/v1/contact/customer/service';
    var that = this;
    wx.request({
      url: requesturl,
      method: "GET",
  ...
  openLayer(event){
    ...
    var requesturl = config.RequestAddressPrefix6 + '/rider/v1/me/work/permit/' + userId;
    var that = this;
    wx.request({
      url: requesturl,
      method: "GET",
